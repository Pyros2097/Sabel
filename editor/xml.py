from PyQt4.Qsci import QsciLexerXML,QsciStyle
from PyQt4.QtCore import QString
from PyQt4.QtGui import QFont, QColor
from globals import config

class XML(QsciLexerXML):   
    ...
    def defaultColor(self, ix):
        for i in self.styles:
          if i.style() == ix:
            return i.color()
        return QsciLexerXML.defaultColor(self, ix)

    def defaultFont(self, ix):
        for i in self.styles:
          if i.style() == ix:
            return i.font()
        return QsciLexerXML.defaultFont(self, ix)

    def defaultPaper(self, ix):
        for i in self.styles:
          if i.style() == ix:
            return i.paper()
        return QsciLexerXML.defaultPaper(self, ix)

    def defaultEolFill(self, ix):
        for i in self.styles:
          if i.style() == ix:
            return i.eolFill()
        return QsciLexerXML.defaultEolFill(self, ix)